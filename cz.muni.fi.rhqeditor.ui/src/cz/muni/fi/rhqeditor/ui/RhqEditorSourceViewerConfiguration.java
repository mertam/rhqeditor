...
public class RhqEditorSourceViewerConfiguration extends AntSourceViewerConfiguration{

		private RhqEditor fEditor;
	     ...
	     */
	    public RhqEditorSourceViewerConfiguration(RhqEditor editor) {
		    super();
		    System.out.println("RhqEditorSourceViewerConfiguration");
		    fEditor= editor;
	    }
...
//------	        
		...
		private void changeContentAssistProcessor() {
			String triggers= fPreferenceStore.getString(AntEditorPreferenceConstants.CODEASSIST_AUTOACTIVATION_TRIGGERS);
			if (triggers != null) {
				RhqEditorCompletionProcessor cp= (RhqEditorCompletionProcessor)fContentAssistant.getContentAssistProcessor(IDocument.DEFAULT_CONTENT_TYPE);
				if (cp != null) {
